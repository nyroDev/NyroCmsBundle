...
<?php echo $view->render('@NyroDevNyroCms/email/_content.html.php', [
    'content' => nl2br($view['translator']->trans('nyrocms.welcome.email.content', [
        '%name%' => $user->getFirstname().' '.$user->getLastName(),
    ])),
]); ?>
<?php echo $view->render('@NyroDevNyroCms/email/_cta.html.php', [
    'url' => $url,
    'text' => $view['translator']->trans('nyrocms.welcome.email.cta'),
]); ?>
<?php echo $view->render('@NyroDevNyroCms/email/_content.html.php', [
    'content' => nl2br($view['translator']->trans('nyrocms.welcome.email.contentFooter', [
        '%name%' => $user->getFirstname().' '.$user->getLastName(),
    ])),
]); ?>
<?php $view['slots']->stop(); ?>